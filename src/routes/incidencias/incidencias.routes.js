...
router.put("/updateForeigner", verifyToken, incidenciasController.updateForeigner);
router.put("/deleteForeigner", verifyToken, incidenciasController.deleteForeigner);
//UPDATE
